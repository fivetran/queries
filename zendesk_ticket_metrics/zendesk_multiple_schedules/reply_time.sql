...
ticket_first_responded_time as (
  select ticket.id as ticket_id,
         ...
         greatest(0, round(timestamp_diff(least(ticket_schedule.schedule_invalidated_at, min(ticket_first_responded_at.responded_at)), ticket_schedule.schedule_created_at, second)/60, 0)) as raw_delta_in_minutes
  from zendesk.ticket
